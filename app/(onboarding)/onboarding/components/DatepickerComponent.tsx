...
const customTheme: CustomFlowbiteTheme["datepicker"] = {
  ...
  popup: {
    ...
    footer: {
      ...
      button: {
        base: "w-full rounded-lg px-5 py-2 text-center text-sm font-medium focus:ring-4 focus:ring-pink-300",
        today:
          "bg-pink-700 text-white hover:bg-pink-800 dark:bg-pink-600 dark:hover:bg-pink-700",
        clear:
    ...
    days: {
      ...
      items: {
        ...
        item: {
          ...
          selected: "bg-pink-700 text-white hover:bg-pink-600",
